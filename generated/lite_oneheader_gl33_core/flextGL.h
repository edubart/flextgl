...
/*
    This file was generated using https://github.com/mosra/flextgl:
        ...
        path/to/flextGLgen.py -D generated/lite_oneheader_gl33_core -t templates/lite_oneheader profiles/gl33_core.txt
...
typedef void (APIENTRY PFNGLCLEARDEPTH_PROC (GLdouble depth));
...
typedef void (APIENTRY PFNGLDEPTHRANGE_PROC (GLdouble n, GLdouble f));
typedef void (APIENTRY PFNGLDISABLE_PROC (GLenum cap));
typedef void (APIENTRY PFNGLDRAWBUFFER_PROC (GLenum buf));
...
typedef void (APIENTRY PFNGLGETDOUBLEV_PROC (GLenum pname, GLdouble * data));
...
typedef void (APIENTRY PFNGLGETTEXIMAGE_PROC (GLenum target, GLint level, GLenum format, GLenum type, void * pixels));
typedef void (APIENTRY PFNGLGETTEXLEVELPARAMETERFV_PROC (GLenum target, GLint level, GLenum pname, GLfloat * params));
typedef void (APIENTRY PFNGLGETTEXLEVELPARAMETERIV_PROC (GLenum target, GLint level, GLenum pname, GLint * params));
...
typedef void (APIENTRY PFNGLLOGICOP_PROC (GLenum opcode));
typedef void (APIENTRY PFNGLPIXELSTOREF_PROC (GLenum pname, GLfloat param));
typedef void (APIENTRY PFNGLPIXELSTOREI_PROC (GLenum pname, GLint param));
typedef void (APIENTRY PFNGLPOINTSIZE_PROC (GLfloat size));
...
typedef void (APIENTRY PFNGLTEXIMAGE1D_PROC (GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void * pixels));
...
typedef void (APIENTRY PFNGLCOPYTEXIMAGE1D_PROC (GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border));
...
typedef void (APIENTRY PFNGLCOPYTEXSUBIMAGE1D_PROC (GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width));
...
typedef void (APIENTRY PFNGLTEXSUBIMAGE1D_PROC (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void * pixels));
...
PFNGLBLENDFUNC_PROC *BlendFunc;
PFNGLCLEAR_PROC *Clear;
PFNGLCLEARCOLOR_PROC *ClearColor;
PFNGLCLEARDEPTH_PROC *ClearDepth;
PFNGLCLEARSTENCIL_PROC *ClearStencil;
PFNGLCOLORMASK_PROC *ColorMask;
PFNGLCULLFACE_PROC *CullFace;
PFNGLDEPTHFUNC_PROC *DepthFunc;
PFNGLDEPTHMASK_PROC *DepthMask;
PFNGLDEPTHRANGE_PROC *DepthRange;
PFNGLDISABLE_PROC *Disable;
PFNGLDRAWBUFFER_PROC *DrawBuffer;
PFNGLENABLE_PROC *Enable;
PFNGLFINISH_PROC *Finish;
PFNGLFLUSH_PROC *Flush;
PFNGLFRONTFACE_PROC *FrontFace;
PFNGLGETBOOLEANV_PROC *GetBooleanv;
PFNGLGETDOUBLEV_PROC *GetDoublev;
PFNGLGETERROR_PROC *GetError;
PFNGLGETFLOATV_PROC *GetFloatv;
PFNGLGETINTEGERV_PROC *GetIntegerv;
PFNGLGETSTRING_PROC *GetString;
PFNGLGETTEXIMAGE_PROC *GetTexImage;
PFNGLGETTEXLEVELPARAMETERFV_PROC *GetTexLevelParameterfv;
PFNGLGETTEXLEVELPARAMETERIV_PROC *GetTexLevelParameteriv;
PFNGLGETTEXPARAMETERFV_PROC *GetTexParameterfv;
PFNGLGETTEXPARAMETERIV_PROC *GetTexParameteriv;
PFNGLHINT_PROC *Hint;
PFNGLISENABLED_PROC *IsEnabled;
PFNGLLINEWIDTH_PROC *LineWidth;
PFNGLLOGICOP_PROC *LogicOp;
PFNGLPIXELSTOREF_PROC *PixelStoref;
PFNGLPIXELSTOREI_PROC *PixelStorei;
PFNGLPOINTSIZE_PROC *PointSize;
PFNGLPOLYGONMODE_PROC *PolygonMode;
PFNGLREADBUFFER_PROC *ReadBuffer;
PFNGLREADPIXELS_PROC *ReadPixels;
PFNGLSCISSOR_PROC *Scissor;
PFNGLSTENCILFUNC_PROC *StencilFunc;
PFNGLSTENCILMASK_PROC *StencilMask;
PFNGLSTENCILOP_PROC *StencilOp;
PFNGLTEXIMAGE1D_PROC *TexImage1D;
PFNGLTEXIMAGE2D_PROC *TexImage2D;
PFNGLTEXPARAMETERF_PROC *TexParameterf;
PFNGLTEXPARAMETERFV_PROC *TexParameterfv;
PFNGLTEXPARAMETERI_PROC *TexParameteri;
PFNGLTEXPARAMETERIV_PROC *TexParameteriv;
PFNGLVIEWPORT_PROC *Viewport;
PFNGLBINDTEXTURE_PROC *BindTexture;
PFNGLCOPYTEXIMAGE1D_PROC *CopyTexImage1D;
PFNGLCOPYTEXIMAGE2D_PROC *CopyTexImage2D;
PFNGLCOPYTEXSUBIMAGE1D_PROC *CopyTexSubImage1D;
PFNGLCOPYTEXSUBIMAGE2D_PROC *CopyTexSubImage2D;
PFNGLDELETETEXTURES_PROC *DeleteTextures;
PFNGLDRAWARRAYS_PROC *DrawArrays;
PFNGLDRAWELEMENTS_PROC *DrawElements;
PFNGLGENTEXTURES_PROC *GenTextures;
PFNGLISTEXTURE_PROC *IsTexture;
PFNGLPOLYGONOFFSET_PROC *PolygonOffset;
PFNGLTEXSUBIMAGE1D_PROC *TexSubImage1D;
PFNGLTEXSUBIMAGE2D_PROC *TexSubImage2D;
...
#define glBlendFunc glpf.BlendFunc
#define glClear glpf.Clear
#define glClearColor glpf.ClearColor
#define glClearDepth glpf.ClearDepth
#define glClearStencil glpf.ClearStencil
#define glColorMask glpf.ColorMask
#define glCullFace glpf.CullFace
#define glDepthFunc glpf.DepthFunc
#define glDepthMask glpf.DepthMask
#define glDepthRange glpf.DepthRange
#define glDisable glpf.Disable
#define glDrawBuffer glpf.DrawBuffer
#define glEnable glpf.Enable
#define glFinish glpf.Finish
#define glFlush glpf.Flush
#define glFrontFace glpf.FrontFace
#define glGetBooleanv glpf.GetBooleanv
#define glGetDoublev glpf.GetDoublev
#define glGetError glpf.GetError
#define glGetFloatv glpf.GetFloatv
#define glGetIntegerv glpf.GetIntegerv
#define glGetString glpf.GetString
#define glGetTexImage glpf.GetTexImage
#define glGetTexLevelParameterfv glpf.GetTexLevelParameterfv
#define glGetTexLevelParameteriv glpf.GetTexLevelParameteriv
#define glGetTexParameterfv glpf.GetTexParameterfv
#define glGetTexParameteriv glpf.GetTexParameteriv
#define glHint glpf.Hint
#define glIsEnabled glpf.IsEnabled
#define glLineWidth glpf.LineWidth
#define glLogicOp glpf.LogicOp
#define glPixelStoref glpf.PixelStoref
#define glPixelStorei glpf.PixelStorei
#define glPointSize glpf.PointSize
#define glPolygonMode glpf.PolygonMode
#define glReadBuffer glpf.ReadBuffer
#define glReadPixels glpf.ReadPixels
#define glScissor glpf.Scissor
#define glStencilFunc glpf.StencilFunc
#define glStencilMask glpf.StencilMask
#define glStencilOp glpf.StencilOp
#define glTexImage1D glpf.TexImage1D
#define glTexImage2D glpf.TexImage2D
#define glTexParameterf glpf.TexParameterf
#define glTexParameterfv glpf.TexParameterfv
#define glTexParameteri glpf.TexParameteri
#define glTexParameteriv glpf.TexParameteriv
#define glViewport glpf.Viewport

#define glBindTexture glpf.BindTexture
#define glCopyTexImage1D glpf.CopyTexImage1D
#define glCopyTexImage2D glpf.CopyTexImage2D
#define glCopyTexSubImage1D glpf.CopyTexSubImage1D
#define glCopyTexSubImage2D glpf.CopyTexSubImage2D
#define glDeleteTextures glpf.DeleteTextures
#define glDrawArrays glpf.DrawArrays
#define glDrawElements glpf.DrawElements
#define glGenTextures glpf.GenTextures
#define glIsTexture glpf.IsTexture
#define glPolygonOffset glpf.PolygonOffset
#define glTexSubImage1D glpf.TexSubImage1D
#define glTexSubImage2D glpf.TexSubImage2D
